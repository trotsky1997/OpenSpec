...
describe("tool-detection", () => {
	...
	describe("SKILL_NAMES", () => {
		it("should contain all skill names matching COMMAND_IDS", () => {
			...
			expect(SKILL_NAMES).not.toContain("openspec-verify-change");
			expect(SKILL_NAMES).not.toContain("openspec-inspect-change");
			expect(SKILL_NAMES).toContain("openspec-clarify-change");
	...
	describe("extractGeneratedByVersion", () => {
		it("should return null for non-existent file", () => {
			const version = extractGeneratedByVersion(
				path.join(testDir, "missing.md"),
			);
