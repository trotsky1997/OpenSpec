...
describe("ChangeMetadataSchema", () => {
	describe("valid metadata", () => {
		...
		it("should accept valid OpenSpeX metadata", () => {
			const result = ChangeMetadataSchema.safeParse({
				schema: "spec-driven",
				variant: "openspex",
				openspex: {
					repoRoot: "/tmp/repo",
					branch: "openspex/add-auth",
	...
	describe("invalid metadata", () => {
		...
		it("should reject OpenSpeX metadata when variant is missing", () => {
			const result = ChangeMetadataSchema.safeParse({
				schema: "spec-driven",
				openspex: {
					repoRoot: "/tmp/repo",
		...
		it("should reject openspex variant without openspex metadata", () => {
			const result = ChangeMetadataSchema.safeParse({
				schema: "spec-driven",
				variant: "openspex",
			});
...
describe("resolveSchemaForChange", () => {
	...
	it("should test full precedence order: CLI > metadata > config > default", async () => {
		...
		// Test each level
		expect(resolveSchemaForChange(changeDir, "custom-schema")).toBe(
			"custom-schema",
		); // CLI wins
