...
function getWelcomeText(): string[] {
	return [
		...
		chalk.dim("  • /opsx:* and /ssx:* slash commands"),
		"",
		chalk.white("Quick start after setup:"),
		`  ${chalk.yellow("/opsx:new")} / ${chalk.yellow("/ssx:new")}      ${chalk.dim("Create a change")}`,
		`  ${chalk.yellow("/opsx:continue")} / ${chalk.yellow("/ssx:continue")} ${chalk.dim("Next artifact")}`,
		`  ${chalk.yellow("/opsx:apply")} / ${chalk.yellow("/ssx:apply")}    ${chalk.dim("Implement tasks")}`,
		"",
