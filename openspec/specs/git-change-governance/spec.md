# git-change-governance Specification

## Purpose
Define SolidSpec requirements for dedicated git worktrees, branch isolation, and merge-governed completion evidence.
...
SolidSpec SHALL treat pull-request review and merge evidence as part of change
completion, not as optional documentation.

#### Scenario: Change not ready for completion without review evidence

- **WHEN** an SolidSpec change lacks its recorded PR reference or merge evidence
...
- **WHEN** an SolidSpec change has completed implementation and review
